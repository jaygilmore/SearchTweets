...
class twitter{
        ...
        /**
         * Recommend setting a user-agent so Twitter knows how to contact you in case of abuse. Include your email
         * @var string
         */
        var $user_agent='';
...
class summize extends twitter
{
        ...
        function search( $terms=false, $callback=false, $limit=false )
        {
                if( !$terms )
                        return false;
